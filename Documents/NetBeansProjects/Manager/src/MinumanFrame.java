...
public class MinumanFrame extends javax.swing.JFrame {
    ...
    ResultSet rs;
    String query2;
    static String query = "SELECT * FROM minuman";
    ...
    public ArrayList<MinumanUser> userList(String qry){
        ArrayList<MinumanUser> userList = new ArrayList<>();
        ...
        try {
            ...
            MinumanUser user;
            while(rs.next()){
                user = new MinumanUser(rs.getString(1),rs.getString(2),rs.getInt(3),rs.getString(4),rs.getInt(5));
                userList.add(user);
            }
        } catch (Exception e) {
    ...
    public void showUser(String qry1){
        ...
        ArrayList<MinumanUser> list = userList(qry1);
        
        Object[] row = new Object[5];
        
        for(int i=0;i<list.size();i++){
            row[0] = list.get(i).getidMinuman();
            row[1] = list.get(i).getnamaMinuman();
            row[2] = list.get(i).gethargaMinuman();
            row[3] = list.get(i).getpromoMinuman();
            row[4] = list.get(i).getstatusMinuman();
            mdl.addRow(row);
        }
        if(list.isEmpty()){
                ...
                .addGroup(editLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(editLayout.createSequentialGroup()
                        .addGroup(editLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(ed1)
                            .addComponent(ed2)
                            .addComponent(ed3, javax.swing.GroupLayout.DEFAULT_SIZE, 100, Short.MAX_VALUE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 123, Short.MAX_VALUE)
                        .addGroup(editLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jLabel7)
                            .addComponent(jLabel8)
                            .addComponent(ed4, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void searchBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchBtnActionPerformed
        ...
        DefaultTableModel mdl = (DefaultTableModel)resultTbl.getModel();
        mdl.setRowCount(0);
        showUser("SELECT * FROM minuman WHERE "+query2+" = '"+searchField.getText()+"'");
        System.out.println("SELECT * FROM minuman WHERE "+query2+" = '"+searchField.getText()+"'");
    ...
    private void ed3KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_ed3KeyTyped
        // TODO add your handling code here:
        Character a = evt.getKeyChar();
        if(Character.isAlphabetic(a)){
            evt.consume();
        }
    }//GEN-LAST:event_ed3KeyTyped
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try {
            ...
            st = conn.createStatement();
            rs = st.executeQuery("SELECT * FROM minuman WHERE idMinuman = '"+idField.getText()+"'");
            rs.next();
            if(rs.getRow()==1){
            ...
            Logger.getLogger(MinumanFrame.class.getName()).log(Level.SEVERE, null, ex);
        }
    }//GEN-LAST:event_jButton3ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
         // TODO add your handling code here:
        String idMinuman = ed1.getText();
        String namaMinuman = ed2.getText();
        ...
        try {
            ...
            PreparedStatement ps = conn.prepareStatement("UPDATE Minuman SET idMinuman = '"+idMinuman+"', namaMinuman = '"+namaMinuman+"', hargaMinuman = '"+harga+"', promoMinuman = '"+promo+"', statusMinuman = '"+status+"' WHERE idMinuman = '"+idField.getText()+"'");
            ps.executeUpdate();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MinumanFrame().setVisible(true);
            }
        });
    }
